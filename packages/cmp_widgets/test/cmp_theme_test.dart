import 'package:cmp_widgets/src/widgets/cmp_theme.dart';
  ...
  group('AppThemes Light Theme Tests', () {
    ...
    group('Text Theme', () {
      ...
      test('label text styles are correct', () {
        ...
        expect(lightTheme.textTheme.labelLarge?.fontWeight,
        ...
        expect(lightTheme.textTheme.labelMedium?.fontWeight,
            equals(FontWeight.bold));

        expect(lightTheme.textTheme.labelSmall?.fontSize, equals(12));
        expect(lightTheme.textTheme.labelSmall?.fontWeight,
            equals(FontWeight.bold));
      });

      test('title text styles are correct', () {
        expect(lightTheme.textTheme.titleLarge?.fontSize, equals(18));
        expect(lightTheme.textTheme.titleLarge?.fontWeight,
            equals(FontWeight.bold));
